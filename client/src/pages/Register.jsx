...
const Register = () => {
  ...
  return (
   <section className="min-h-screen bg-gradient-to-br from-zinc-900 to-zinc-800 grid place-items-center px-4 py-12">
   {/* wave top */}
  <svg
  ...
  >
   ...
   {/* wave top */}
     {/* left section */}
  <div className="z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
    {/* Texto informativo / bienvenida */}
    <div className="text-zinc-300 px-4">
      <h1 className="text-4xl font-bold mb-4 text-indigo-500">Welcome to Our Community!</h1>
     ...
     {/* left section */}
    {/* form */}
    <div className={`bg-zinc-900 border border-zinc-700 p-8 rounded-2xl shadow-2xl max-w-md mx-auto ${loading ? "opacity-90 pointer-events-none" : ""}`}>
