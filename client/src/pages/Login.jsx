...
const Login = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-900 to-zinc-800 grid place-items-center px-4">
      <svg
      ...
      <div className="z-10 w-full max-w-md bg-zinc-900 border border-zinc-700 p-8 rounded-2xl shadow-2xl">
        ...
        <p className="mt-6 text-center text-sm text-zinc-400">
          Don't have an account? <a href="/register" className="text-indigo-400 hover:underline">Register here</a>
        </p>
      </div>
