import { Eye, Delete, Loader2 } from "lucide-react";
import { useState } from "react";
import { Link } from "react-router-dom";
const ProjectList = ({ onSelect, projects, onDelete, deletingId }) => {
        ...
        <section className="mb-12">
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project) => (
                    <Link to={`/dashboard/project/${project.project_id}` } key={project.project_id}>
                        <div onClick={() => handleProjectDetails(project)}
